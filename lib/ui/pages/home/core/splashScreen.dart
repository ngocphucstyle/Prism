...
class _SplashWidgetState extends State<SplashWidget> {
  ...
  Future<bool> loading() async {
    try {
      ...
      await remoteConfig.setConfigSettings(RemoteConfigSettings(minimumFetchInterval: Duration.zero, fetchTimeout: Duration.zero));
      ...
      final rcBool =  remoteConfig.lastFetchStatus;
