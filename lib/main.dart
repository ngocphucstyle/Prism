...
import 'package:Prism/auth/badgeModel.dart' as badgeModel;
...
Future<void> main() async {
  ...
  //       Hive.registerAdapter<badgeModel.Badge>(badgeModel.BadgeAdapter());
  ...
  prefs.put(
      "lightAccent",
      int.parse(
          lightAccent.toString().replaceAll("Color(", "").replaceAll(")", "")));
  darkAccent = Color(int.parse(
      prefs.get('darkAccent', defaultValue: "0xffe57697").toString()));
  prefs.put(
      "darkAccent",
      int.parse(
          darkAccent.toString().replaceAll("Color(", "").replaceAll(")", "")));
  optimisedWallpapers = prefs.get('optimisedWallpapers') == true;
  // if (optimisedWallpapers) {
  //   prefs.put('optimisedWallpapers', true);
  // } else {
